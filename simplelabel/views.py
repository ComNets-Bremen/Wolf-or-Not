...
def get_statistics(request):
    ...
    data = {
            ...
            "percent_done_3" : round(sufficient_polls_3/len(p)*100, 1) if len(p) else 0,
            "percent_done_2" : round(sufficient_polls_2/len(p)*100, 1) if len(p) else 0,
            }
